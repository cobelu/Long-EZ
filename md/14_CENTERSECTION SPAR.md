...
Cut out all foam parts for the center section spar, page 14-7.
Micro joints are ok if your pieces are too small.
Carve or sand the local clearance depressions in the urethane pieces at 
...
Hold it in position with a few nails, and bondo several 1" x 1" pine sticks to the fixture and up the face of part CS3 as shown.
...
Fit (don't bond) interior bulkheads CS6 and CS7, trim if neccessary to allow for 1 ply of BID.
...
Prepare all the foam surfaces inside the spar box with slurry and 
apply layup 2 – one ply of BID at 45° orientaion to all three faces, including the end bulkheads.
...
Now, apply the local reinforcements (layup 3) at the inboard wing attach hard point areas (see section B-B and H-H).
The first ply of BID is layed up over the interior bulkheads (both sides) and lapped onto the top, bottom and aft faces of 
the spar box, 1" **except** where the attach points will be, where it laps 5".
Now layup three plies of UND 4" wide over the inboard wing attach hard point areas as shown (lapping onto top and aft face).
The first is 10" long, second 8", third 6", fibers run along long dimension. Flox two WA1 aluminum plates into position centered over the attach points (BL 25-25" from center) and layup 1 ply of BID lapping over WA1's approximately 1" all around.
Place saran wrap over the metal WA1 and weight in position with about 5 lb. weight.
...
Refer to section C-C, E-E, F-F, and G-G, and the sketch below. As in the inboard reinforcement (layup 3) layup the 1 ply BID over the bulkhead lapping 5" inboard, then 3 UND plies 4" wide as show, then the metal LWA-1 plates, then a final BID over the metal parts that laps onto the bulkhead.
...
See the sketch below and section views to locate positions for the 1/4" thick aluminum blocks.
...
Now, referring to the sketches below, epoxy the W16 spruce wedges 
in place and layup a 10-ply BID reinforcement that connects the 
spar with the inside face of the fuselage longerons (4 places top and bottom).
