...
attchment reinforcements, build and rig ailerons and 
install wing-mounted aileron controls.
Study carefully the dimensioned plan view drawing and all the section drawings to get thoroughly aquainted with your wings before you start.
...
The jig templates disasemble into 4 parts (2 parts for Jig #5) to allow you to partially remove the templates for wing skinning etc. 
...
Cutout the indivdual pieces and glue to your jigs as shown, using care to line up the WL 17.4 lines and the T.E. (trailing edge) line.
...
Be sure the assembled jigs are square and parrallel. 
...
Template constrution - glue page A9 to page A10 at the line shown.
...
Study the plan view of the wing (page 19-10) to aquaint yourself with the three major areas of the wing:
1. Inboard, that portion from BL 23 to BL 55.5, aft of the centersection spar.
...
Now locate FC 3 and layout the demensions shown.
...
Now, fabricate WI8s the two pieces of .016 thick alumimum shown and bond them over the access depressions in the spar cap area – 5 minute epoxy is ok.
...
Then, epoxy tfie LWA3 and LW2 plates on, centered over the other metal parts.
...
A spar cap that is a little-­low is prefered to one that is high (easier filled and finishing sanding won't cut into wing skin).
...
Sissor trim the inboard edge BL 55.5 rib wingtip edge L.E. and T.E. to less than 1/2" excess.
...
Follow the instructions in step 5 to layup the spar cap **except** use the lengths  and dimensions delow.
...
Do **not** substiutue nylo-seal tubing.
Layout the locations shown using the fullsize template for the small curve at the tip and a straight line to the dimension at the root.
...
This is best done by first painting epoxy underneath, then on **each** ply (1) layup skin leaving excess hanging down (2) sissor trim to 2" (3) **wipe** onto bottom with a squeege.
Successive plies can be sissored shorter to taper over­lap.
Wrap the skin down the inboard face similar to the bottom skin, overlapping it 1", peel ply the 3" x 12" stips near the attach depressions.
...
Squeege well for a smooth, light layup.
...
The foam is also completely removed at the **LWA6** (1/4" thick alumimum) block.
...
Study Sections H-H, I-I, J-J, K-K and L-L to aquaint yourself with your aileron and wing trailing-ege spar.
...
Sissor trim to 1/4" after each ply.
...
After assuring A2 and A5 are parallel to each other, jig the aileron trailing edge down, round the corners, bond A10 and A2, and A5 in with wet micro andlayup 1 ply BID at 45° over the leading edge lapping 1" onto top and bottom skins.
Peel-ply the edges.
This is layup #10.
...
If 0.3 lb aft of the steel bar is not enough you will have to discard and build new ailerons – your first ones have execessively heavy, epoxy-rich skins and cannot be made safe.
...
First fabricate the phenolic block and metal parts· shown full size Pl t"-1? dimensions not shown. Drill (#12) and bolt the parts together 
as shown. 
